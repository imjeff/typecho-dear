...
$output .= '<li><span><i><time datetime="'.date('Y年m月d日',$archives->created).'" itemprop="datePublished">'.date('Y-m-d',$archives->created).'</time></i></span>'.$archives->category .'&nbsp·&nbsp<a href="'.$archives->permalink .'">'. $archives->title .'</a></li>';
endwhile;
$output .= '</ul>';
echo $output;
?>
